          ...
          <form onSubmit={handleRegister}>
            ...
            >
                ...
                >
                    <form onSubmit={handleRegister}>
                        ...
                        <input
                            ...
                            style={inputStyle(errors.userName)}
                        />
                        {errors.userName && <div style={fieldErrorStyle}>{errors.userName}</div>}
                        <div style={{ marginBottom: errors.userName ? '10px' : '16px' }} />
                        ...
                        <input
                            ...
                            style={inputStyle(errors.passwordConfirm)}
                        />
                        {errors.passwordConfirm && <div style={fieldErrorStyle}>{errors.passwordConfirm}</div>}
                        <div style={{ marginBottom: errors.passwordConfirm ? '10px' : '16px' }} />
                ...
                >
                    ...
                    >
                        <div style={{ fontWeight: 'bold', fontSize: '13px', marginBottom: '8px', color: '#1a1a1a' }}>
                            利用規約：
                        </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px' }}>
                        <button
                            type="button"
                            onClick={() => { setAgreeTerms(!agreeTerms); setErrors(prev => ({ ...prev, terms: '' })) }}
                            style={{
                                width: '20px',
                                height: '20px',
                                borderRadius: '50%',
