    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
                ...
                {/* 説明テキスト */}
                <p className="text-white/80 text-sm text-center leading-relaxed font-sans mb-5 px-2">
                ...
                {/* テキストが空の場合のヒント */}
                {!message.trim() && (
                    <p className="text-white/30 text-xs text-center mt-3 font-sans">
                        メッセージを入力してから星をドラッグしてください
                    </p>
                )}
            </div>
        </div>
